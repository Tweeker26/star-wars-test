<template>
  <div v-loading="loading">
    ...
    <div v-if="data" class="page">
      ...
      <div v-if="starships.length" class="page__subtitle">Starships:</div>
      ...
      <div v-if="vehicles.length" class="page__subtitle">Vehicles:</div>
      ...
      <div v-if="films.length" class="page__subtitle">Films:</div>
